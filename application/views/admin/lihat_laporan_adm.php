    ...
    <div class="card-body">
        <div class="table-responsive">
            <div class="row mt-2 ml-1 mb-4">
                <a href="<?php echo site_url('dashboard/cetak_pdf_pengaduan');?>" class="btn btn-info mt-2 mb-3"><i class="fas fa-download mr-2"></i> Download PDF</a> 
                <a href="<?php echo site_url('dashboard/cetak_xls_pengaduan');?>" class="btn btn-warning ml-2 mt-2 mb-3"><i class="fas fa-download mr-2"></i> Download Excel</a> 
            </div>
        ...
        <div class="modal-content">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><textarea name="tanggapan" id="" cols="30" rows="5" class="form-control"></textarea></td>
                </tr>
                <tr>
                    <td>ID Petugas</td>
